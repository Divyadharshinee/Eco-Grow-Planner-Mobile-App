...
public class DiseaseDiseaseActivity extends AppCompatActivity {
        ...
        try {
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    runOnUiThread(() -> {
                        Toast.makeText(DiseaseDiseaseActivity.this, "Request failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    runOnUiThread(() -> {
                        try {
                            ...
                            Toast.makeText(DiseaseDiseaseActivity.this, "Error parsing response: " + e.getMessage(), Toast.LENGTH_SHORT).show();
